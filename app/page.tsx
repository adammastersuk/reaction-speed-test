...
const SCORES_API_PATH = '/reaction-speed-test/api/scores';
...
export default function HomePage() {
  ...
  const [leaderboardLabel, setLeaderboardLabel] = useState('All-Time Top 5');
  ...
  const loadScores = useCallback(async () => {
    ...
    try {
      ...
      setLeaderboardLabel(payload.leaderboardLabel ?? 'All-Time Top 5');
  ...
  const submitScore = useCallback(async () => {
    ...
    try {
      const response = await fetch(SCORES_API_PATH, {
        method: 'POST',
      ...
      <div className="container">
        ...
        <section className="leaderboard-wrap">
          <div className="actions-top">
            ...
            >
              {showLeaderboard ? 'Hide All-Time Top 5' : 'Show All-Time Top 5'}
            </button>
          </div>
